		...
		return (
			<div className="homeContainer">
				<section id="homeIntroduction">
					...
					<p>
						If you are interested in learning more about Star Trek from a more objective perspective, and with a much wider scope of information, I highly recommend you follow this link to Star Trek's primary wiki database, <a href="http://memory-alpha.wikia.com/wiki/Portal:Main">Memory Alpha</a>.
					</p>
